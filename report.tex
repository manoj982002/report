...
\usepackage{adjustbox}     % to auto-fit wide tables


% Improved table column formatting
...
\end{tabular}
\end{center}
\vspace{1cm} % Optional space below the table at bottom of page
...
The data transmission process follows these steps:

\begin{enumerate}[leftmargin=*]
    \item \textbf{Data Collection}
    \begin{itemize}[leftmargin=*]
        \item Fixed air pressure applied to gauge setup
        \item Known constant pressure serves as base input
        \item Manual calibration with fixed setup values
    \end{itemize}
    
    \item \textbf{Data Processing}
    \begin{itemize}[leftmargin=*]
        \item PIC microcontroller processes pressure input
        \item Computes volume using mathematical expressions
        \item Converts to diameter using linear calibration
    \end{itemize}
    
    \item \textbf{Data Transmission}
    \begin{itemize}[leftmargin=*]
        \item Wired transmission via W5100 Ethernet controller
        \item Wireless transmission via Neoton IC + LoRa/Bluetooth
    \end{itemize}
\end{enumerate}
...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Parameter} & \textbf{Wired (LAN)} & \textbf{Wireless} \\ \hline
Interface & Ethernet (W5100) & Bluetooth/LoRa \\ \hline
Speed & 10/100 Mbps & 300 bps - 115.2 kbps \\ \hline
Range & Up to 100m & 10m-2.8km \\ \hline
Protocol & TCP/IP & Custom RF \\ \hline
\end{tabular}
\end{table}
...
Range & 2.8 km & 15m & 100m \\ \hline
Power Consumption & 120mA & 40mA & 50mA \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}[leftmargin=*]
    \item High accuracy (0.1\% error margin)
    \item Dual-mode communication capability
    \item Robust environmental adaptability
